...
export function FloatingWhatsApp() {
  ...
  // Auto-open the welcome tooltip after 3 seconds (once per session)
  useEffect(() => {
          ...
          >
            ...
            <div className="bg-[#25D366] px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold text-sm">Trading House</p>
                  <p className="text-white/80 text-xs">{t('onlineStatus')}</p>
                </div>
              </div>
              <button
            ...
            <div className="px-4 py-4">
              {/* Timestamp */}
              <p className="text-center text-xs text-steel/60 mb-3">{t('timestamp')}</p>

              {/* Message bubble */}
              <div className="bg-[#E1F5EB] rounded-xl rounded-tl-none px-3.5 py-2.5 max-w-[260px]">
                <p className="text-ink text-sm leading-relaxed">
                  {t('welcomeMessage')}
                </p>
                <p className="text-[10px] text-steel/50 text-right mt-1">{t('messageTime')}</p>
              </div>
            </div>
            ...
            <div className="px-4 pb-4">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#1EB954] text-white font-semibold text-sm rounded-xl px-4 py-3 transition-colors duration-200 active:scale-[0.98]"
              >
